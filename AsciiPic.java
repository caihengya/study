...
/**
 * @program: test.test
 * @description: 图片转ASCII图片码  图片填充文字
 * @author: Mr.ch
 * @create: 2020-06-19
 **/
...
//     boolean ret = false;
    ...
    public static void createAsciiPic(final String path) {
        ...
        try {
            ...
            //输出到指定文件中
            final BufferedWriter fos = new BufferedWriter(new FileWriter("C:\\Users\\Administrator\\Desktop\\abc.txt",false));   //true表示是否追加
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream in = null;
        //缩放后需要保存的路径
        File saveFile = new File("C:\\Users\\Administrator\\Desktop\\bb.jpg");
        try {
            //原图片的路径
            in = new FileInputStream(new File("C:\\Users\\Administrator\\Desktop\\455.jpg"));
        ...
        AsciiPic.createAsciiPic("C:\\Users\\Administrator\\Desktop\\bb.jpg");

        //图片填充文字
        createFongImg("C:\\Users\\Administrator\\Desktop\\455.jpg","C:\\Users\\Administrator\\Desktop\\temp.jpg");
     ...
     * @param url
     */
    public static void createFongImg(String path,String url){
        String base = "铁憨憨";
        try{
            ...
            ImageIO.write(newImage, "JPG", new FileOutputStream(url));
        }catch (Exception e){
            e.printStackTrace();
        }
    }
